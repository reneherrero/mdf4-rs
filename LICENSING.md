...
mdf4-rs is available under a **dual-licensing** model:
...
This means you can use mdf4-rs in:
...
For commercial licensing inquiries, pricing, and terms, please [create an **Issue** in GitHub](https://github.com/reneherrero/mdf4-rs/issues).
...
By contributing to mdf4-rs, you agree that your contributions will be
